...
# Subset of output variables used in the differentiable model for gradient tests
GRAD_OUTPUT_VARS = ["LAI", "TWLV", "TAGP", "TWSO"]
...
class TestDiffWofost72Gradients:
    ...
    output_names = ["LAI", "TWLV", "TAGP", "TWSO"]
    ...
    gradient_mapping = {
        "TDWI": ["LAI", "TWLV", "TAGP", "TWSO"],
        "SPAN": ["LAI"],
        "RGRLAI": ["LAI"],
        "TBASE": ["LAI"],
        "PERDL": ["TWLV"],
        "KDIFTB": ["LAI", "TAGP", "TWSO"],
        "SLATB": ["LAI"],
    }
